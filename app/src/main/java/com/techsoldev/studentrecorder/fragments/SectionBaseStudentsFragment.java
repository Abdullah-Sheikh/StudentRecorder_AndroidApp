...
import com.techsoldev.studentrecorder.adapters.SectionAdapter;
import com.techsoldev.studentrecorder.adapters.StudentAdapter;
import com.techsoldev.studentrecorder.models.Student;

import java.util.ArrayList;

public class SectionBaseStudentsFragment extends  Fragment {

    public SectionBaseStudentsFragment(String sectionName) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_section_base_students,container,false);
        ...
        RecyclerView recyclerView = (RecyclerView) v.findViewById(R.id.section_base_students_recyclerView);
        // set a LinearLayoutManager with default vertical orientation
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(linearLayoutManager);
        // call the constructor of CustomAdapter to send the reference and data to Adapter
        SectionAdapter customAdapter = new SectionAdapter(getContext(),students, sectionName);
